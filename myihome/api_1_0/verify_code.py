...
# from myihome.tasks.task_sms import send_sms
from myihome.tasks.sms.tasks import send_sms
...
def get_sms_code(phone_num):
    ...
    result = send_sms.delay(phone_num, [sms_code, int(constants.SMS_CODE_REDIS_EXPIRES / 60)], 1)
